...
############
		...
		sleep(10)
			...
			child = pexpect.spawn('ssh -o StrictHostKeyChecking=no admin@'+config.grid_HA_VIP)
                        ...
                        sleep(05)
                        output = output.replace("\r\n"," ")
                        Public_Local_IPv4 = re.search('Public Local IPv4 Address(.*)Public', output)
                        if Public_Local_IPv4==None:
                                assert False
                        else:
                                Public_Local_IPv4 = Public_Local_IPv4.group(0)
                        Public_Local_IPv4=Public_Local_IPv4.replace("Public Local IPv4 Address:","").replace("Public","").replace(" ","")
                        print("\n")
                        print("Public_Local_IPv4 ",Public_Local_IPv4)
                        print("\n")
			####
                        child = pexpect.spawn('ssh -o StrictHostKeyChecking=no root@'+config.grid_HA_VIP)
                        child.logfile=sys.stdout
			...
			data = ['ListenAddress '+config.grid_HA_VIP,'ListenAddress '+Public_Local_IPv4,'ListenAddress '+Active_HA_Local_IP]
			print("data is ",data)
			print("\n")
                        for i in data:
                                if i in output:
		...
		sleep(10)
			...
			###
                        ...
                        sleep(05)
                        output = output.replace("\r\n"," ")
                        HA_Active_IPv6_Address = re.search('Untagged(.*)IPv6 Gateway Address', output)
			print("HA_Active_IPv6_Address ",HA_Active_IPv6_Address)
                        if HA_Active_IPv6_Address==None:
                                assert False
                        else:
                                HA_Active_IPv6_Address = HA_Active_IPv6_Address.group(0)
                        HA_Active_IPv6_Address=HA_Active_IPv6_Address.replace("IPv6 Address:","").replace("IPv6 Gateway Address","").replace(" ","").replace("Untagged","")
			HA_Active_IPv6_Address = HA_Active_IPv6_Address[:-3]
                        print("\n")
                        print("HA_Active_IPv6_Address ",HA_Active_IPv6_Address)
                        print("\n")
                        ####
                        ...
                        sleep(05)
                        output = output.replace("\r\n"," ")
                        HA_Active_Public_Local_IPv6_Address = re.search('Public Local IPv6 Address(.*)HA', output)
                        if HA_Active_Public_Local_IPv6_Address==None:
                                assert False
                        else:
                                HA_Active_Public_Local_IPv6_Address = HA_Active_Public_Local_IPv6_Address.group(0)
                        HA_Active_Public_Local_IPv6_Address=HA_Active_Public_Local_IPv6_Address.replace("Public Local IPv6 Address:","").replace("HA","").replace(" ","")
                        print("\n")
                        print("HA_Active_Public_Local_IPv6_Address ",HA_Active_Public_Local_IPv6_Address)
                        print("\n")
			###
                        ...
                        output = output.replace("\r\n"," ")
                        print("\n")
			print("output start ",output,"output ends")
                        print("\n")
                        #data = ['ListenAddress ['+config.grid_ipv6_HA_vip_validation+']','ListenAddress ['+config.grid_ipv6_HA_Active_validation+']']
			data = ['ListenAddress ['+HA_Active_IPv6_Address+']','ListenAddress ['+HA_Active_Public_Local_IPv6_Address+']']
...
###############
		...
		sleep(05)
			...
			if Active_HA_Local_IP==None:
				assert False
                        ...
                        print("\n")
                        ####
                        HA_Active_IP = re.search('Public Local IPv4 Address(.*)Public Local IPv6 Address', output)
                        if HA_Active_IP==None:
                                assert False
                        else:
                                HA_Active_IP = HA_Active_IP.group(0)
                        HA_Active_IP=HA_Active_IP.replace("Public Local IPv4 Address:","").replace("Public Local IPv6 Address","").replace(" ","")
                        print("\n")
                        print("HA_Active_IP",HA_Active_IP)
                        print("\n")

                        #child = pexpect.spawn('ssh -o StrictHostKeyChecking=no root@'+config.grid_HA_ACTIVE)
                        child = pexpect.spawn('ssh -o StrictHostKeyChecking=no root@'+HA_Active_IP)
                        child.logfile=sys.stdout
                        child.expect('#')
                        child.sendline('grep ListenAddress /storage/etc/sshd_config')
                        child.expect('#')
			...
			sleep(10)
                        output = output.replace("\r\n"," ")
                        print("output start ",output,"output end")
                        data = ['ListenAddress '+config.grid_HA_VIP,'ListenAddress '+HA_Active_IP,'ListenAddress '+Active_HA_Local_IP]
                        print("data --> ",data)
                        print("\n")
                        for i in data:
                                if i in output:
		...
		sleep(05)
                try:
                        ...
                        output = output.replace("\r\n"," ")
                        sleep(05)
                        Active_HA_Local_IPv6 = re.search('Public Local IPv6 Address(.*)HA Local IPv4 Address', output)
                        if Active_HA_Local_IPv6==None:
                                assert False
                        else:
                                Active_HA_Local_IPv6 = Active_HA_Local_IPv6.group(0)
                        Active_HA_Local_IPv6=Active_HA_Local_IPv6.replace("Public Local IPv6 Address:","").replace("HA Local IPv4 Address","").replace(" ","")
                        print("\n")
                        print("Active_HA_Local_IPv6",Active_HA_Local_IPv6)
                        print("\n")
                        #######
                        child = pexpect.spawn('ssh -o StrictHostKeyChecking=no root@'+Active_HA_Local_IPv6)
                        child.logfile=sys.stdout
                        child.expect('#')
                        child.sendline('grep ListenAddress /storage/etc/sshd_config')
                        child.expect('#')
                        ...
                        print("\n")
                        #data = ['ListenAddress ['+config.grid_ipv6_HA_vip_validation+']','ListenAddress ['+config.grid_ipv6_HA_Active_validation+']']
                        data = ['ListenAddress ['+config.grid_ipv6_HA_vip_validation+']','ListenAddress ['+Active_HA_Local_IPv6+']']
                        for i in data:
                                if i in output:
                                        assert True
                                        print(i)
...
################
		...
		sleep(05)
                try:
                        ...
                        print("output1 start",output1,"output1 end")
                        child.sendline('show network')
                        child.expect('>')
                        output = child.before
                        output = output.replace("\r\n"," ")
                        print("output start",output,"output end")
                        if "Passive" in output1:
                                print("\n")
                                print(config.grid_HA_PASSIVE," IP is Passive")
                                print("\n")
                                grid_HA_PASSIVE = re.search('Public Local IPv4 Address(.*)Public Local IPv6 Address', output)
                                grid_HA_PASSIVE = grid_HA_PASSIVE.group(0)
                                grid_HA_PASSIVE = grid_HA_PASSIVE.replace("Public Local IPv4 Address:","").replace("Public Local IPv6 Address","").replace(" ","")
                                print("grid_HA_PASSIVE ",grid_HA_PASSIVE)
                                ##
                                Passive_HA_Local_IP = re.search('HA Local IPv4 Address(.*)Grid Status', output)
                                Passive_HA_Local_IP = Passive_HA_Local_IP.group(0)
                                Passive_HA_Local_IP = Passive_HA_Local_IP.replace("HA Local IPv4 Address:","").replace("Grid Status","").replace(" ","")
                                ...
                                print("\n")
                                print(config.grid_HA_PASSIVE," IP is Active")
                                print("\n")
                                print(config.grid_HA_ACTIVE," IP is Passive")
                                print("\n")
                                child = pexpect.spawn('ssh -o StrictHostKeyChecking=no admin@'+config.grid_HA_ACTIVE)
                                child.logfile=sys.stdout
                                child.expect('password: ')
                        ...
                        ####
                        child = pexpect.spawn('ssh -o StrictHostKeyChecking=no root@'+grid_HA_PASSIVE)
                        child.logfile=sys.stdout
                        child.expect('#')
                        child.sendline('grep ListenAddress /storage/etc/sshd_config')
                        child.expect('#')
                        ...
                        data = ['ListenAddress '+grid_HA_PASSIVE,'ListenAddress '+Passive_HA_Local_IP]
                        print("\n")
                        for i in data:
                                if i in output:
                                        assert True
		...
		sleep(05)
                try:
                        ...
                        if "Passive" in output1:
                                ...
                                print(config.grid_HA_PASSIVE," IP is Passive")
                                print("\n")
                                grid_ipv6_HA_Passive = re.search('Public Local IPv6 Address(.*)HA Local IPv4 Address', output)
                                grid_ipv6_HA_Passive = grid_ipv6_HA_Passive.group(0)
                                grid_ipv6_HA_Passive = grid_ipv6_HA_Passive.replace("Public Local IPv6 Address:","").replace("HA Local IPv4 Address","").replace(" ","")
                                print("grid_ipv6_HA_Passive ",grid_ipv6_HA_Passive)
                        else:
                                print("\n")
                                print(config.grid_ipv6_HA_Passive," IP is Active")
                                print("\n")
                                print(config.grid_ipv6_HA_Active," IP is Passive")
                                print("\n")
                                child = pexpect.spawn('ssh -o StrictHostKeyChecking=no admin@'+config.grid_ipv6_HA_Active)
                                child.logfile=sys.stdout
                                child.expect('password: ')
                ...
                try:
                        child = pexpect.spawn('ssh -o StrictHostKeyChecking=no root@'+grid_ipv6_HA_Passive)
                        child.logfile=sys.stdout
                        child.expect('#')
                        child.sendline('grep ListenAddress /storage/etc/sshd_config')
                        child.expect('#')
                        ...
                        print("\n")
                        print("\n")
                        data = ('ListenAddress ['+grid_ipv6_HA_Passive+']')
                        if data in output:
                        	assert True
                        else:
                        	assert False
...
############
		...
		sleep(10)
			...
			sleep(05)
                        output = output.replace("\r\n"," ")
                        Active_HA_IPv4 = re.search('Public Local IPv4 Address(.*)Public Local IPv6 Address', output)
			if Active_HA_IPv4==None:
				assert False
			else:
                        	Active_HA_IPv4 = Active_HA_IPv4.group(0)
                        Active_HA_IPv4 = Active_HA_IPv4.replace("Public Local IPv4 Address:","").replace("Public Local IPv6 Address","").replace(" ","")
                        print("\n")
                        print("Active_HA_IPv4 ",Active_HA_IPv4)
                        ###
                        Active_HA_Local_IP = re.search('HA Local IPv4 Address(.*)Grid Status', output)
                        if Active_HA_Local_IP==None:
                                assert False
			...
			sleep(05)
                        output = output.replace("\r\n"," ")
			print(output)
                        data = ['ListenAddress '+config.grid_HA_VIP,'ListenAddress '+Active_HA_IPv4,'ListenAddress '+Active_HA_Local_IP]
                        print("\n")
                        for i in data:
                                if i in output:
                                        assert True
		...
		sleep(20)
                ...
                output = output.replace("\r\n"," ")
                #print("output start",output,"output end")
                grid_ipv6_HA_Active = re.search('Public Local IPv6 Address(.*)HA Local IPv4 Address', output)
                grid_ipv6_HA_Active = grid_ipv6_HA_Active.group(0)
                grid_ipv6_HA_Active = grid_ipv6_HA_Active.replace("Public Local IPv6 Address:","").replace("HA Local IPv4 Address","").replace(" ","")
                print("\n")
                print("grid_ipv6_HA_Active ",grid_ipv6_HA_Active)
                ...
                try:
                        ...
                        print("\n")
                        print("\n")
                        data = ['ListenAddress ['+config.grid_ipv6_HA_vip_validation+']','ListenAddress ['+grid_ipv6_HA_Active+']']
                        for i in data:
                                if i in output:
                                        assert True
                                        print(i)
		...
		sleep(10)
                ...
                try:
                        ...
                        if "Active" in output1:
                                ...
                                print(config.grid_HA_PASSIVE," IP is Active")
                                print("\n")
                                grid_HA_ACTIVE = re.search('Public Local IPv4 Address(.*)Public Local IPv6 Address', output)
                                grid_HA_ACTIVE = grid_HA_ACTIVE.group(0)
                                grid_HA_ACTIVE = grid_HA_ACTIVE.replace("Public Local IPv4 Address:","").replace("Public Local IPv6 Address","").replace(" ","")
                                print("grid_HA_ACTIVE ",grid_HA_ACTIVE)
                                ##
                                Active_HA_Local_IP = re.search('HA Local IPv4 Address(.*)Grid Status', output)
                                Active_HA_Local_IP = Active_HA_Local_IP.group(0)
                                Active_HA_Local_IP = Active_HA_Local_IP.replace("HA Local IPv4 Address:","").replace("Grid Status","").replace(" ","")
                                ...
                                print(config.grid_HA_PASSIVE," IP is Passive")
                                print("\n")
                                print(config.grid_HA_ACTIVE," IP is Active")
                                print("\n")
                                child = pexpect.spawn('ssh -o StrictHostKeyChecking=no admin@'+config.grid_HA_ACTIVE)
                                child.logfile=sys.stdout
                                child.expect('password: ')
			...
			sleep(10)
                        child = pexpect.spawn('ssh -o UserKnownHostsFile=/dev/null -o StrictHostKeyChecking=no root@'+grid_HA_ACTIVE)
                        child.logfile=sys.stdout
                        child.expect('#')
			sleep(05)
                        child.sendline('grep ListenAddress /storage/etc/sshd_config')
			...
			sleep(05)
                        output = output.replace("\r\n"," ")
                        print("output start",output,"output end")
                        data = ['ListenAddress '+config.grid_HA_VIP,'ListenAddress '+grid_HA_ACTIVE,'ListenAddress '+Active_HA_Local_IP]
                        print("data is",data)
                        print("\n")
                        for i in data:
                                if i in output:
		...
		sleep(05)
                try:
                        ...
                        if "Active" in output1:
                                ...
                                print("\n")
                                print(config.grid_ipv6_HA_Passive," IP is Passive")
                                print("\n")
                                print(config.grid_ipv6_HA_Active," IP is Active")
                                print("\n")
                                child = pexpect.spawn('ssh -o StrictHostKeyChecking=no admin@'+config.grid_ipv6_HA_Active)
                                child.logfile=sys.stdout
                                child.expect('password: ')
                        ...
                        sleep(10)
                        child = pexpect.spawn('ssh -o UserKnownHostsFile=/dev/null -o StrictHostKeyChecking=no root@'+grid_ipv6_HA_Active)
                        child.logfile=sys.stdout
                        child.expect('#')
                        child.sendline('grep ListenAddress /storage/etc/sshd_config')
                        child.expect('#')
...
################
		...
		sleep(60)
                ...
                try:
                        ...
                        if "Passive" in output1:
                                ...
                                grid_HA_PASSIVE = grid_HA_PASSIVE.group(0)
                                grid_HA_PASSIVE = grid_HA_PASSIVE.replace("Public Local IPv4 Address:","").replace("Public Local IPv6 Address","").replace(" ","")
                                print("grid_HA_ACTIVE ",grid_HA_PASSIVE)
                                ##
                                Passive_HA_Local_IP = re.search('HA Local IPv4 Address(.*)Grid Status', output)
                                Passive_HA_Local_IP = Passive_HA_Local_IP.group(0)
                                Passive_HA_Local_IP = Passive_HA_Local_IP.replace("HA Local IPv4 Address:","").replace("Grid Status","").replace(" ","")
		...
		sleep(05)
                ...
                try:
                        ...
                        sleep(10)
                        child = pexpect.spawn('ssh -o UserKnownHostsFile=/dev/null -o StrictHostKeyChecking=no root@'+grid_ipv6_HA_Passive)
                        child.logfile=sys.stdout
                        child.expect('#')
                        child.sendline('grep ListenAddress /storage/etc/sshd_config')
                        child.expect('#')
