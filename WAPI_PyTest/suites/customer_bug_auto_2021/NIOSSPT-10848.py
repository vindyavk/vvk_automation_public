...
def get_engineBoots():
        ...
        data="cat /var/lib/snmp/snmpd.conf | grep engineBoots"
        print("*******SNMPD.CONF*******",data)
	stdin, stdout, stderr = client.exec_command(data)
        stdout=stdout.read()
        engineBoots = re.findall('[0-9]+',stdout)
        return engineBoots
...
class NIOSSPT_10848(unittest.TestCase):
    ...
    def test_001_check_engineBoots_after_reboot(self):
        ...
        print("******ENGINER BOOTS BEFORE*******",engineBoots_before)
	...
	print("********ENGINER BOOTS AFTER*********",engineBoots_after)
