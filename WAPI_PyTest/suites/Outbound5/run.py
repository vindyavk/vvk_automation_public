...
var_hash["GRID2_MASTER_VIP"]=master2
var_hash["GRID2_MASTER_FQDN"]="ib-"+'-'.join(master2.split('.'))+".infoblox.com"
...
#command = "py.test test_DNSSEC_secure.py --tb=long --html=RFE-6478.html --junit-xml=RFE-6478.xml -vv"
