...
class  Discovery_member_reports(unittest.TestCase):
    ...
    def test_1_Device_components(self):
        ...
        test1 = [{"Device IP":"10.40.16.10","Network View":"discovery_view","Device Name":"DELL-PC8024F","Device Model":"Powerconnect 8024F"}]
    ...
    def test_2_Device_interface_inventory(self):
        ...
        test2=[{"Network View":"discovery_view","Device IP":"10.40.16.10","Device Name":"DELL-PC8024F","Device Model":"Powerconnect 8024F","Admin Status":"up","Operation Status":"down"}]
    ...
    def test_3_Device_inventory(self):
        ...
        test3=[{"Asset Type":"Physical Device","Device Name":"unknown","Device IP":"10.40.16.12","Network View":"discovery_view"}]
    ...
    def test_4_IPAMv4_device_networks(self):
        ...
        test4=[{"IPAM Network":"167.1.1.0/24","Utilization %":"64.9"}]
    ...
    def test_5_IP_address_inventory(self):
        ...
        test5=[{"IP Address":"10.40.16.1","Network View":"discovery_view","Managed":"False","Management Platform":"Network Insight"}]
