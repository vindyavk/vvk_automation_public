...
#######################################################################################################
      ...
      def test_025_Add_and_Validate_tlsa_record(self):
          ...
          data = {"name": "_443._tcp.tlsa.test.com","certificate_data": "1A1B","view": "default"}
          response = ib_NIOS.wapi_request('POST', object_type="record:tlsa",fields=json.dumps(data),grid_vip=config.grid_vip)
          print(response)
          output = ib_NIOS.wapi_request('GET',object_type="record:tlsa",params="?_inheritance=True&_return_fields=name,certificate_data,view",grid_vip=config.grid_vip)
          print(output)
          result = ['"certificate_data": "1A1B"','"name": "_443._tcp.tlsa.test.com"','"view": "default"']
          for i in result:
            if i in output:
                  assert True
            else:
      ...
      def test_027_Add_and_Validate_txt_record(self):
          ...
          data = {"name": "txt.test.com","text": "\"\"","view": "default"}
          ...
          print(output)
          result = ['"name": "txt.test.com"','"view": "default"']
          for i in result:
            if i in output:
                  assert True
            else:
...
#####################################################################################################################################
      ...
      def test_292_Add_and_validate_Substitute_TXT_record_rule_in_default_dns_view(self):
          ...
          data = {"name": "txt.rpz.com","text": "\"\"","view": "default","rp_zone": "rpz.com"}
