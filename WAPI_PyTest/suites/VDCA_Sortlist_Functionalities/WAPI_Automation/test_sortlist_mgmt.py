...
#       logging.info("Performing queries from another client, validate response based on the subnet in sortlist")
    ...
    def test_13_validated_a_record_responses_query_with_ipv6_client_ip(self):
        logging.info('-'*30+"Test Case 1 Execution Started"+'-'*30)
	logging.info("Disable Sortlist in View and Member Level")
    ...
    def test_14_validated_a_record_responses_query_with_ipv6_client_subnet(self):
        logging.info('-'*30+"Test Case 1 Execution Started"+'-'*30)
    ...
    def test_15_validated_a_record_responses_query_with_any_interface(self):
        logging.info('-'*30+"Test Case 1 Execution Started"+'-'*30)
	...
	logging.info("Result with performing by queries with ipv6 interface")	
	logging.info(ips)
	...
	logging.info("Result with performing by queries with ANY interface")
        logging.info(ips1)
        assert ips == ips1
