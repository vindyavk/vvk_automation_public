"""
 ...
 ReportName          : DHCP Usage Statistics
...
TEST Steps:
      ...
      3.  Validation : comparing Search results with Reterived 'DHCPv4 Usage Statistics' report without delta.
"""

class DHCPUsageStatistics(unittest.TestCase):
    @classmethod
    def setup_class(cls):
        logger.info('-'*15+"START:DHCP Usage Statistics"+'-'*15)
        logger.info ("Preparation has executed 1 hour before as this report will take 1 hour to update")

        cls.test1=[]
        temp={}
        temp["Network view"]="custom_view_1"
        temp["Network"]="30.0.0.0"
        temp["CIDR"]="24"
        temp["Ranges"]="1"
        temp["Provisioned"]="50"
        temp["Used"]="2"       
        ...
        temp={}
        temp["Network view"]="custom_view_1"
        temp["Network"]="32.0.0.0"
        temp["CIDR"]="24"
        temp["Ranges"]="1"
        temp["Provisioned"]="100"
        temp["Used"]="2"
        temp["Static"]="1"
        temp["Dynamic"]="1"
        cls.test1.append(temp)
    ...
    def teardown_class(cls):
        logger.info('-'*15+"END:DHCP Usage Statistics"+'-'*15)
