...
class DNSScavengeObjectCountTrend(unittest.TestCase):
    ...
    def setup_class(cls):
        ...
        papi.import_csv(path+'/ib_data/DNS_Scavenge/dns_scavenging_view_1_nsg.csv')   
        #papi.import_csv('ib_data/DNS_Scavenge/dns_scavenging_view_2_nsg.csv')
        papi.import_csv(path+'/ib_data/DNS_Scavenge/dns_scavenging_view_2_nsg.csv')     
        ...
        os.chdir(path+'/ib_data/DNS_Scavenge')
        ...
        time.sleep(190) #wait for report update
        #time.sleep(60)
