...
class DNSQueryTrendPerIPBlockGroup(unittest.TestCase):
	...
	config.client_eth1_ip9,config.client_eth1_ip10,config.client_eth1_ip11,config.client_eth1_ip12,config.client_eth1_ip13)
        ...
        os.system("dig @"+config.grid_vip+" -f "+path+"/API_Automation_08_12_20/WAPI_PyTest/Reporting_FR/ib_data/DNS_Query/DNS_Query_Trend_Per_IP_Block_Group/group1.txt -b "+config.client_eth1_ip9 +" > /dev/null 2>&1")
        #time.sleep(5)
        ...
        os.system("dig @"+config.grid_vip+" -f "+path+"/API_Automation_08_12_20/WAPI_PyTest/Reporting_FR/ib_data/DNS_Query/DNS_Query_Trend_Per_IP_Block_Group/group2.txt -b "+config.client_eth1_ip10 +" > /dev/null 2>&1")
        #time.sleep(5)
        ...
        os.system("dig @"+config.grid_vip+" -f "+path+"/API_Automation_08_12_20/WAPI_PyTest/Reporting_FR/ib_data/DNS_Query/DNS_Query_Trend_Per_IP_Block_Group/group3.txt -b "+config.client_eth1_ip11 +" > /dev/null 2>&1")
        #time.sleep(5)
        ...
        os.system("dig @"+config.grid_vip+" -f "+path+"/API_Automation_08_12_20/WAPI_PyTest/Reporting_FR/ib_data/DNS_Query/DNS_Query_Trend_Per_IP_Block_Group/group4.txt -b "+config.client_eth1_ip12 +" > /dev/null 2>&1")
        #time.sleep(5)
        ...
        os.system("dig @"+config.grid_vip+" -f "+path+"/API_Automation_08_12_20/WAPI_PyTest/Reporting_FR/ib_data/DNS_Query/DNS_Query_Trend_Per_IP_Block_Group/group5.txt -b "+config.client_eth1_ip13 +" > /dev/null 2>&1")
        #time.sleep(5)
	...
	cls.test1=[ \
        ...
        time.sleep(450) #wait till reports gets udpated
