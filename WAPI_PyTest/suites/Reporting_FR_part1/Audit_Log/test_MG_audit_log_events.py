...
class AuditLogEvents(unittest.TestCase):
    ...
    def test_1_audit_log_events_validate_add_modify_delete_events(self):
        ...
        search_str="search sourcetype=ib:audit index=ib_audit ACTION=DELETED (host=\"*\") | sort -_time | eval Member=host | eval Timestamp=strftime(_time, \"%Y-%m-%d %H:%M:%S %Z\") | rename ADMIN as \"Admin\", ACTION as \"Action\", OBJECT_TYPE as \"Object Type\", OBJECT_NAME as \"Object Name\", EXEC_STATUS as \"Execution Status\", MESSAGE as \"Message\" | table \"Timestamp\" \"Admin\" \"Action\" \"Object Type\" \"Object Name\" \"Execution Status\" \"Message\" \"Member\""
        
        #search_str="search sourcetype=ib:audit index=ib_audit ACTION=DELETED (host=\"*\") | sort -_time | eval MESSAGE=replace(MESSAGE, \"\\\\040\", \" \") | eval MESSAGE=replace(MESSAGE, \"\\\\042\", \"\"\") | eval MESSAGE=replace(MESSAGE, \"\\\\054\", \",\") | eval MESSAGE=replace(MESSAGE, \"\\\\072\", \":\") | eval MESSAGE=replace(MESSAGE, \"\\\\075\", \"=\") | eval MESSAGE=replace(MESSAGE, \"\\\\076\", \"&gt;\") | eval MESSAGE=replace(MESSAGE, \"\\\\133\", \"\[\") | eval MESSAGE=replace(MESSAGE, \"\\\\134\", \"\\\") | eval MESSAGE=replace(MESSAGE, \"\\\\135\", \"\]\") | eval OBJECT_NAME=replace(OBJECT_NAME, \"\\\\040\", \" \") | eval OBJECT_NAME=replace(OBJECT_NAME, \"\\\\042\", \"\"\") | eval OBJECT_NAME=replace(OBJECT_NAME, \"\\\\054\", \",\") | eval OBJECT_NAME=replace(OBJECT_NAME, \"\\\\072\", \":\") | eval OBJECT_NAME=replace(OBJECT_NAME, \"\\\\075\", \"=\") | eval OBJECT_NAME=replace(OBJECT_NAME, \"\\\\076\", \"&gt;\") | eval OBJECT_NAME=replace(OBJECT_NAME, \"\\\\133\", \"\[\") | eval OBJECT_NAME=replace(OBJECT_NAME, \"\\\\134\", \"\\\") | eval OBJECT_NAME=replace(OBJECT_NAME, \"\\\\135\", \"\]\") | eval Member=host | eval Timestamp=strftime(_time, \"%Y-%m-%d %H:%M:%S %Z\") | rename ADMIN as \"Admin\", ACTION as \"Action\", OBJECT_TYPE as \"Object Type\", OBJECT_NAME as \"Object Name\", EXEC_STATUS as \"Execution Status\", MESSAGE as \"Message\" | table \"Timestamp\" \"Admin\" \"Action\" \"Object Type\" \"Object Name\" \"Execution Status\" \"Message\" \"Member\""
