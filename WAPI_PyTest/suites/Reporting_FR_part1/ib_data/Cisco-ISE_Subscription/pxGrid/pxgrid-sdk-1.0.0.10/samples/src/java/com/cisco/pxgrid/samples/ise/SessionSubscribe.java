...
/**
 * Demonstrates how to use an xGrid client to subscribe to session notifications
 * generated by ISE.
 * 
 * @author jangwin
 *
...
public class SessionSubscribe {
	protected static final Logger log = LoggerFactory.getLogger(SessionSubscribe.class);
		...
		throws Exception
	{
		...
		if (filter != null) {
			SessionDirectoryFactory.registerNotification(con, new SampleNotificationHandler(), filter);
		} else {
