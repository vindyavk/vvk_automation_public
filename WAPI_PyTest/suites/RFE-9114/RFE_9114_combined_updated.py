...
class Network(unittest.TestCase):
    ...
    def test_013_validate_ipv4_routing_table(self):
        ...
        print (result)
        match1 = "dev eth1 proto ifplugd"
        match2 = "dev eth3 proto ifplugd metric 10"
    ...
    def test_016_validate_ipv4_routing_table(self):
        ...
        result=connection.send_command("ip route")
        print (result)
        match1 = "dev eth3 proto ifplugd"
        match2 = "dev eth1 proto ifplugd metric 10"
        assert (( match1 in result) and (match2 in result)) 
        display_msg("Test Completed")
    ...
    def test_029_validate_ipv6_routing_table(self):
        ...
        print (result)
        match1 = "dev eth1 proto ifplugd metric 1024"
        match2 = "dev eth3 proto ifplugd metric 1124"
        assert (( match1 in result) and (match2 in result))
        display_msg("Test Completed")        
    ...
    def test_032_validate_ipv6_routing_table(self):
        ...
        result=connection.send_command("ip -6 route")
        print (result)
        match1 = "dev eth3 proto ifplugd metric 1024"
        match2 = "dev eth1 proto ifplugd metric 1124"
        assert (( match1 in result) and (match2 in result)) 
        display_msg("Test Completed") 
...
############# HA PAIR ################
	...
	response = os.system("reboot_system -H "  +config.ha1_hw_name+ " -c " +config.user)	
	sleep(60)	
	member.is_device_up(config.ha1_mgmt)	
	sleep(60)
