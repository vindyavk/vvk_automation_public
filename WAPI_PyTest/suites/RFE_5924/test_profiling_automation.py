...
class ProfilingAutomation(unittest.TestCase):
    ...
    def test_001_add_profile_without_inherited(self):
    ...
    def test_002_add_profile_with_inherited(self):
    ...
    def test_003_associate_member_for_profile(self):
    ...
    def test_004_disable_multiple_dns_tcp_request_for_profile_as_true(self):
    ...
    def test_005_disable_multiple_dns_tcp_request_for_profile_as_false(self):
    ...
    def test_006_modify_events_per_second_per_rule_true(self):
    ...
    def test_007_modify_per_second_per_rule_false(self):
    ...
    def test_008_modify_overridden_ruleset(self):
    ...
    def test_009_modify_overridden_ruleset_false(self):
    ...
    def test_010_search_name_for_profile(self):
    ...
    def test_011_delete_profile_for_name(self):
    ...
    def test_012_delete_profile_using_comment_field(self):
    ...
    def test_013_adding_cloned_profile_using_source_profile(self):
    ...
    def test_014_added_profile_using_source_member(self):
    ...
    def test_015_search_name_for_profile(self):
    ...
    def test_016_validate_profile_name_get_operation(self):
    ...
    def test_017_validate_hardware_model_get_operation(self):
    ...
    def test_018_update_another_profile_in_member_1(self):
    ...
    def test_019_update_another_profile_in_member_1(self):
    ...
    def test_020_search_hw_model_for_member_threatprotection(self):
    ...
    def test_021_search_hw_type_for_hw_type(self):
    ...
    def test_022_update_disable_field_true_for_custom_rule(self):
    ...
    def test_023_update_disable_field_false_for_custom_rule(self):
    ...
    def test_024_update_disable_field_false_for_custom_rule(self):
    ...
    def test_025_addd_duplicate_profile_negative_case(self):
    ...
    def test_026_add_profile_with_more_than_256_characters_negative_case(self):
    ...
    def test_027_add_profile_with_idn_characters(self):
    ...
    def test_028_add_profile_with_same_name_after_delete_operation(self):
    ...
    def test_029_modify_rulesets_for_the_added_profile(self):
    ...
    def test_030_added_comments_with_idn_characters_for_the_added_profile(self):
        ...
        get_comment = ib_NIOS.wapi_request('GET', object_type = ref+'?_return_fields=comment')
        factory = json.loads(get_version)
        logging.info(factory)
