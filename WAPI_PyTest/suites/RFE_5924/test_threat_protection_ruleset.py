...
class RFE5924_Automation(unittest.TestCase):
    ...
    def test_001_get_threat_protection_ruleset_validate_ruleset(self):
    ...
    def test_002_get_threat_protection_ruleset_validate_add_type(self):
    ...
    def test_003_get_threat_protection_ruleset_validate_is_factory_field(self):
    ...
    def test_004_get_threat_protection_ruleset_validate_do_not_delete(self):
    ...
    def test_005_get_threat_protection_ruleset_modify_validate_do_not_delete(self):
    ...
    def test_006_get_threat_protection_ruleset_modify_validate_comment(self):
    ...
    def test_007_get_threat_protection_ruleset_modify_validate_do_not_delete(self):
    ...
    def test_008_get_threat_protection_ruleset_search_version(self):
    ...
    def test_009_get_threat_protection_ruleset_search_add_type(self):
    ...
    def test_010_get_threat_protection_ruleset_search_add_type(self):
    ...
    def test_011_get_member_threat_protection_ruleset_ipv4_ipv6(self):
    ...
    def test_012_get_member_threat_protection_ruleset_ipv4_ipv6(self):
    ...
    def test_013_get_member_threat_protection_ruleset_version(self):
    ...
    def test_014_update_use_current_ruleset_as_false_for_ruleset(self):
        sleep(60)
    ...
    def test_015_get_ruleset_override_events_per_second_per_rule(self):
    ...
    def test_016_get_member_threat_protection_ruleset_version_override(self):
    ...
    def test_017_get_member_threat_protection_ruleset_version_override(self):
    ...
    def test_018_grid_threat_protection_enable_nat_address(self):
    ...
    def test_019_grid_threat_protection_disable_nat_address(self):
    ...
    def test_020_grid_threat_protection_enable_nat_network(self):
        sleep(30)
    ...
    def test_021_grid_threat_protection_disable_nat_network(self):
        sleep(30)
    ...
    def test_022_grid_threat_protection_enable_nat_all(self):
    ...
    def test_023_grid_threat_protection_disable_nat_all(self):
    ...
    def test_024_grid_threat_protection_disable_nat_rules_values(self):
    ...
    def test_025_grid_threat_protection_disable_nat_rules(self):
    ...
    def test_026_member_statistics_grid(self):
    ...
    def test_027_search_member_for_statistics(self):
    ...
    def test_028_add_custom_rule_blacklist_fqdn_lookup(self):
        ...
        print(json.loads(get_rule_temp_ref))
    ...
    def test_029_validate_sid_in_rules_txt_file_validate_functionality_of_added_blacklist_udp_fqdn_type_rule(self):   
        ...
        ssh_cmd = 'ssh -o StrictHostKeyChecking=no -o BatchMode=yes -o UserKnownHostsFile=/dev/null root@'+str(config.grid_member4_vip)+' " grep -ir '+str(sid_value)+' /infoblox/var/atp_conf/rules.txt " '
        ...
        sys_log_validation = 'ssh -o StrictHostKeyChecking=no -o BatchMode=yes -o UserKnownHostsFile=/dev/null root@'+str(config.grid_member4_vip)+' " tail -200 /var/log/syslog | grep \'BLACKLIST .*\' " '
    ...
    def test_030_put_blacklist_udp_fqdn_type_for_custom_rule_name_negative_case(self):
    ...
    def test_031_update_disable_field_as_true_for_blacklist_udp_fqdn(self):
    ...
    def test_032_update_disable_field_as_false_for__blacklist_udp_fqdn_type(self):
    ...
    def test_033_update_log_severity_value_and_name_in_black_udp_fqdn_lookup(self):
    ...
    def test_034_validate_sid_in_rules_txt_file_and_validated_functionality_of_modified_blacklist_udp_fqdn_type(self):    
    ...
    def test_035_delete_custom_rule_blacklist_udp_fqdn(self):
    ...
    def test_036_add_custom_blacklist_tcp_fqdn(self):
    ...
    def test_037_validate_sid_in_rules_txt_file_and_validated_functionality_of_added_blacklist_tcp_fqdn_type(self): 
        ...
        sys_log_validation = 'ssh -o StrictHostKeyChecking=no -o BatchMode=yes -o UserKnownHostsFile=/dev/null root@'+str(config.grid_member4_vip)+' " tail -20 /var/log/syslog | grep \'BLACKLIST .*\' " '
        out1 = commands.getoutput(sys_log_validation)
        logging.info(out1)
        print out1
    ...
    def test_038_update_blacklist_tcp_fqdn_type_name_negative_case(self):
    ...
    def test_039_update_disable_field_false_for_custom_rule(self):
    ...
    def test_040_update_log_severity_and_fqdn_for_blacklist_tcp_fqdn_type(self):
    ...
    def test_041_validate_sid_in_rules_txt_file_and_validated_functionality_of_modified_blacklist_tcp_fqdn_type(self):     
    ...
    def test_042_delete_custom_rule_blacklist_tcp_fqdn(self):
    ...
    def test_043_add_whitelist_tcp_fqdn(self):
        ...
        get_rule_temp_ref = ib_NIOS.wapi_request('GET', object_type="threatprotection:ruletemplate?sid=120300000&ruleset=%s"%ref_version_2)
        res_rule_template = json.loads(get_rule_temp_ref)
        ref_1_temp = json.loads(get_rule_temp_ref)[0]['_ref']
        print ref_1_temp
    ...
    def test_044_validate_sid_in_rules_txt_file_and_validated_functionality_of_added_whitelist_tcp_fqdn_type(self):
    ...
    def test_045_update_whitelist_tcp_fqdn_name_negative_case(self):
    ...
    def test_046_update_disable_field_false_for_custom_rule(self):
    ...
    def test_047_update_log_severity_and_fqdn_for_whitelist_tcp_fqdn(self):
    ...
    def test_048_validate_sid_in_rules_txt_file_and_validated_functionality_of_modified_whitelist_tcp_fqdn_type(self):
    ...
    def test_049_delete_custom_rule_whitelist_tcp_fqdn(self):
    ...
    def test_050_add_custom_rule_whitelist_udp_fqdn(self):
        ...
        get_rule_temp_ref = ib_NIOS.wapi_request('GET', object_type="threatprotection:ruletemplate?sid=120300500&ruleset=%s"%ref_version_2)
        res_rule_template = json.loads(get_rule_temp_ref)
        ref_1_temp = json.loads(get_rule_temp_ref)[0]['_ref']
        print ref_1_temp
    ...
    def test_051_validate_sid_in_rules_txt_file_and_validated_functionality_of_added_whitelist_udp_fqdn_type(self):
    ...
    def test_052_put_whitelist_udp_domain_negative_case(self):
    ...
    def test_053_update_disable_field_as_false_for_custom_rule(self):
    ...
    def test_054_update_fqdn_and_log_severity_for_whitelist_udp_domain_type(self):
    ...
    def test_055_validate_sid_in_rules_txt_file_and_validated_functionality_of_modified_whitelist_udp_fqdn_type(self):       
    ...
    def test_056_delete_custom_rule_whitelist_udp_domain(self):
    ...
    def test_057_add_custom_rule_whitelist_pass_tcp_priority_rate_limiting(self):
        ...
        get_rule_temp_ref = ib_NIOS.wapi_request('GET', object_type="threatprotection:ruletemplate?sid=120102000&ruleset=%s"%ref_version_2)
        res_rule_template = json.loads(get_rule_temp_ref)
        ref_1_temp = json.loads(get_rule_temp_ref)[0]['_ref']
        print ref_1_temp
    ...
    def test_058_validate_sid_in_rules_txt_file_and_validated_functionality_of_added_whitelist_pass_tcp_ip_prior_to_rate_limiting(self):
    ...
    def test_059_update_whitelist_pass_tcp_priority_rate_limiting_negative_case(self):
    ...
    @pytest.mark.run(order=59)
    def test_059_update_disable_field_false_for_whitelist_pass_tcp_ip_prior_to_rate_limiting(self):
    ...
    def test_060_put_whitelist_pass_tcp_ip_priority_rate_limiting(self):
    ...
    def test_061_validate_sid_in_rules_txt_and_validated_functionality_for__whitelist_pass_tcp_ip_prior_to_rate_limiting(self):
    ...
    def test_062_delete_custom_rule_whitelist_pass_tcp_prior_limiting(self):
    ...
    def test_063_add_custom_rule_rate_limited_tcp_fqdn_lookup(self):
    ...
    def test_064_validate_sid_txt_and_functionality_for_rate_limited_tcp_fqdn_lookup(self):
        ...
        sys_log_validation = 'ssh -o StrictHostKeyChecking=no -o BatchMode=yes -o UserKnownHostsFile=/dev/null root@'+str(config.grid_member4_vip)+' " tail -200 /var/log/syslog | grep \'RATE LIMITED .*\' " '
        out1 = commands.getoutput(sys_log_validation)
        print out1
    ...
    def test_065_update_type_rate_limited_tcp_fqdn_lookup_negative_case(self):
    ...
    def test_066_update_disable_field_false_for_custom_rule(self):
    ...
    def test_067_update_log_severity_and_fqdn_for_rate_limited_tcp_fqdn_lookup(self):
    ...
    def test_068_validate_sid_in_rules_txt_file_and_validated_functionality_of_modified_rate_limited_tcp_fqdn_type(self):
    ...
    def test_069_delete_custom_rule_rate_limited_tcp_fqdn(self):
    ...
    def test_070_add_custom_rule_rate_limited_udp_fqdn_lookup(self):
    ...
    def test_071_put_blacklist_udp_fqdn_type(self):
    ...
    def test_072_update_rate_limited_udp_fqdn_lookup_negative_case(self):
    ...
    @pytest.mark.run(order=72)
    def test_072_update_disable_field_false_for_custom_rule(self):
        logging.info('-'*30+"Test Case 72 Execution Started"+'-'*30)
        logging.info("Modify Disable field for custom rule with value as true")
    ...
    def test_073_update_log_severity_and_fqdn_for_rate_limited_udp_fqdn_lookup(self):
    ...
    def test_074_validate_sid_in_rules_txt_file_and_validated_functionality_of_modified_rate_limited_udp_fqdn_lookup(self):
    ...
    def test_075_delete_custom_rule_rate_limited_udp_fqdn_lookup(self):
    ...
    def test_076_add_custom_rule_rate_limited_tcp_ip(self):
    ...
    @pytest.mark.run(order=76)
    def test_076_validate_sid_in_rules_txt_file_and_validated_functionality_of_rate_limited_tcp_ip(self):
        logging.info('-'*30+"Test Case 76 Execution Started"+'-'*30)
        logging.info("Validating SID in rules.txt file")
        get_custom_rule = ib_NIOS.wapi_request('GET', object_type='threatprotection:grid:rule?name~=Rate.*')
        custom_rule=json.loads(get_custom_rule)
    ...
    def test_077_put_rate_limited_tcp_ip_negative_case(self):
    ...
    def test_078_update_disable_field_false_for_custom_rule(self):
    ...
    def test_079_update_log_severity_and_fqdn_for_rate_limited_tcp_ip(self):
...
#        assert custom_rule[0]["name"] == "Rate limited:10.0.0.20"
    ...
    def test_080_validate_sid_in_rules_txt_file_and_validated_functionality_of_modified_rate_limited_tcp_ip(self):
    ...
    def test_081_delete_custom_rule_rate_limited_tcp_ip(self):
    ...
    def test_082_add_custom_rule_rate_limited_udp_ip(self):
        ...
        get_rule_temp_ref = ib_NIOS.wapi_request('GET', object_type="threatprotection:ruletemplate?sid=120201000&ruleset=%s"%ref_version_2)
        res_rule_template = json.loads(get_rule_temp_ref)
        ref_1_temp = json.loads(get_rule_temp_ref)[0]['_ref']
        print ref_1_temp
    ...
    def test_083_validate_sid_in_rules_txt_file_and_validated_functionality_of_modified_rate_limited_udp_ip(self):
    ...
    def test_084_update_rate_limited_udp_ip_negative_case(self):
    ...
    def test_085_update_disable_field_false_for_custom_rule(self):
    ...
    def test_086_update_log_severity_and_fqdn_rate_limited_udp_ip(self):
 ...
 #      assert custom_rule[0]["name"] == "Rate limited:20.0.0.20"
    ...
    def test_087_validate_sid_in_rules_txt_file_and_validated_functionality_of_modified_blacklist_udp_fqdn_type(self):
    ...
    def test_089_delete_custom_rule_rate_limited_udp_id(self):
    ...
    def test_090_add_custom_rule_rate_limited_udp_dns_message_type(self):
        ...
        get_rule_temp_ref = ib_NIOS.wapi_request('GET', object_type="threatprotection:ruletemplate?sid=130481000&ruleset=%s"%ref_version_2)
        res_rule_template = json.loads(get_rule_temp_ref)
        ref_1_temp = json.loads(get_rule_temp_ref)[0]['_ref']
        print ref_1_temp
    ...
    def test_091_validate_sid_in_rules_txt_file_and_validated_functionality_of_added_rate_limited_udp_dns_messagetype(self):
    ...
    def test_092_update_rate_limited_udp_dns_messgae_type_negative_case(self):
    ...
    def test_093_update_disable_field_false_for_custom_rule(self):
    ...
    def test_094_update_rate_limited_udp_dns_message_type_negative_case(self):
    ...
    def test_095_put_validate_sid_in_rules_txt_file_and_validated_functionality_of_modified_rate_limited_udp_dns_message_type(self):
    ...
    def test_096_delete_custom_rule_rate_limited_udp_dns_messgae_type(self):
    ...
    def test_097_add_custom_rule_rate_limited_tcp_dns_message_type(self):
        ...
        get_rule_temp_ref = ib_NIOS.wapi_request('GET', object_type="threatprotection:ruletemplate?sid=130482000&ruleset=%s"%ref_version_2)
        res_rule_template = json.loads(get_rule_temp_ref)
        ref_1_temp = json.loads(get_rule_temp_ref)[0]['_ref']
        print ref_1_temp
    ...
    def test_098_put_validate_sid_in_rules_txt_file_and_validated_functionality_of_added_rate_limited_dns_message_type(self):    
        get_custom_rule = ib_NIOS.wapi_request('GET', object_type='threatprotection:grid:rule?name~=Rate.*')
        custom_rule=json.loads(get_custom_rule)
        print get_custom_rule
        print type(custom_rule)
    ...
    def test_099_update_rate_limited_tcp_dns_message_type_negative_case(self):
    ...
    def test_104_add_custom_rule_pass_udp_dns_message_type(self):
        ...
        get_rule_temp_ref = ib_NIOS.wapi_request('GET', object_type="threatprotection:ruletemplate?sid=130483000&ruleset=%s"%ref_version_2)
        res_rule_template = json.loads(get_rule_temp_ref)
        ref_1_temp = json.loads(get_rule_temp_ref)[0]['_ref']
        print ref_1_temp
    ...
    def test_111_add_custom_rule_pass_tcp_dns_message_type(self):
        ...
        get_rule_temp_ref = ib_NIOS.wapi_request('GET', object_type="threatprotection:ruletemplate?sid=130484000&ruleset=%s"%ref_version_2)
        res_rule_template = json.loads(get_rule_temp_ref)
        ref_1_temp = json.loads(get_rule_temp_ref)[0]['_ref']
        print ref_1_temp
    ...
    def test_118_add_custom_rule_blacklist_udp_fqdn_lookup_dns_message_type(self):
        ...
        get_rule_temp_ref = ib_NIOS.wapi_request('GET', object_type="threatprotection:ruletemplate?sid=120305000&ruleset=%s"%ref_version_2)
        res_rule_template = json.loads(get_rule_temp_ref)
        ref_1_temp = json.loads(get_rule_temp_ref)[0]['_ref']
        print ref_1_temp
    ...
    def test_119_update_blacklist_udp_fqdn_lookup_dns_message_type_negative_case(self):         
        ...
        sys_log_validation = 'ssh -o StrictHostKeyChecking=no -o BatchMode=yes -o UserKnownHostsFile=/dev/null root@'+str(config.grid_member4_vip)+' " tail -200 /var/log/syslog | grep \'BLACKLIST UDP .*\' " '
        out1 = commands.getoutput(sys_log_validation)
        print out1
    ...
    def test_124_add_custom_rule_blacklist_tcp_fqdn_lookup_dns_message_type(self):
        ...
        get_rule_temp_ref = ib_NIOS.wapi_request('GET', object_type="threatprotection:ruletemplate?sid=120306000&ruleset=%s"%ref_version_2)
        res_rule_template = json.loads(get_rule_temp_ref)
        ref_1_temp = json.loads(get_rule_temp_ref)[0]['_ref']
        print ref_1_temp
    ...
    def test_125_validate_sid_in_rules_txt_file_and_validated_functionality_of_added_blacklist_tcp_dns_message_type(self):
        ...
        sys_log_validation = 'ssh -o StrictHostKeyChecking=no -o BatchMode=yes -o UserKnownHostsFile=/dev/null root@'+str(config.grid_member4_vip)+' " tail -200 /var/log/syslog | grep \'BLACKLIST TCP .*\' " '
        out1 = commands.getoutput(sys_log_validation)
        print out1
...
#        assert custom_rule[0]["name"] == "Blacklist TCP DNS Message type: CNAME record for black_tcp_dns_modified.com"
    ...
    def test_131_add_custom_rule_whitelist_pass_udp_prior_rate_limiting(self):
        ...
        get_rule_temp_ref = ib_NIOS.wapi_request('GET', object_type="threatprotection:ruletemplate?sid=120101000&ruleset=%s"%ref_version_2)
        res_rule_template = json.loads(get_rule_temp_ref)
        ref_1_temp = json.loads(get_rule_temp_ref)[0]['_ref']
        print ref_1_temp
    ...
    def test_138_add_custom_rule_blacklist_drop_udp_ip_prior_to_rate_limiting(self):
        ...
        get_rule_temp_ref = ib_NIOS.wapi_request('GET', object_type="threatprotection:ruletemplate?sid=120103000&ruleset=%s"%ref_version_2)
        res_rule_template = json.loads(get_rule_temp_ref)
        ref_1_temp = json.loads(get_rule_temp_ref)[0]['_ref']
        print ref_1_temp
   ...
   #    get_custom_rule = ib_NIOS.wapi_request('GET', object_type='threatprotection:grid:rule?name=Blacklist:11.0.0.1')
    ...
    def test_139_validate_sid_in_rules_txt_file_and_validated_functionality_of_added_blacklist_drop_ip_prior_to_rate_limiting(self):
        ...
        sys_log_validation = 'ssh -o StrictHostKeyChecking=no -o BatchMode=yes -o UserKnownHostsFile=/dev/null root@'+str(config.grid_member4_vip)+' " tail -200 /var/log/syslog | grep \'BLACKLIST DROP .*\' " '
        out1 = commands.getoutput(sys_log_validation)
        print out1
    ...
    def test_145_add_custom_rule_blacklist_drop_tcp_ip_prior_to_rate_limiting(self):
        ...
        get_rule_temp_ref = ib_NIOS.wapi_request('GET', object_type="threatprotection:ruletemplate?sid=120104000&ruleset=%s"%ref_version_2)
        res_rule_template = json.loads(get_rule_temp_ref)
        ref_1_temp = json.loads(get_rule_temp_ref)[0]['_ref']
        print ref_1_temp
    ...
    def test_158_publish_changes_with_sequential(self):
        ...
        audit_log_validation = 'ssh -o StrictHostKeyChecking=no -o BatchMode=yes -o UserKnownHostsFile=/dev/null root@'+str(config.grid_vip)+' " tail -200 /infoblox/var/audit.log | grep PublishChanges  " '
