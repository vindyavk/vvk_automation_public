...
if(run_type == 'single_indexer' or  'single_site_cluster' or 'multi_site_cluster'):
    ...
    # Give some sleep to manually add the grid_ipv6 in config.py
#    print("Manually add grid_ipv6 in config.py file..")
#    sleep(20)
...
#    sleep(3600)
    ...
    os.system("pytest -vss prep_query_count_details_by_Subscriber_ID.py")
    sleep(60)
