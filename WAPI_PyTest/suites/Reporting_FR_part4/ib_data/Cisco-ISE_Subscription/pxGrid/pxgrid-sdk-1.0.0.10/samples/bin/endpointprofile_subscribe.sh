...
$JAVA_HOME/bin/java -cp .:"$SDK_LIB_DIR"/*:"$SAMPLES_LIB_DIR"/* -Dlogback.configurationFile="$LOG_CONFIG" -DsamplesHome="$SAMPLES_HOME_DIR" -DsamplesProperties="$SAMPLES_PROPERTIES_FILE" -DsamplesVersion="1.0.0.10" com.cisco.pxgrid.samples.ise.EndpointProfileMetaDataSubscribe $*
