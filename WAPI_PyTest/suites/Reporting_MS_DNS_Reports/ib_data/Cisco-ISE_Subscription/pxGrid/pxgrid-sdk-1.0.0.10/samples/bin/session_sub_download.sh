...
$JAVA_HOME/bin/java -cp .:"$SDK_LIB_DIR"/*:"$SAMPLES_LIB_DIR"/* -Dhttps.protocols="TLSv1" -Dlogback.configurationFile="$LOG_CONFIG" -DsamplesHome="$SAMPLES_HOME_DIR" -DsamplesProperties="$SAMPLES_PROPERTIES_FILE" -DsamplesVersion="1.0.0.10" com.cisco.pxgrid.samples.ise.SessionSubscribeDownload $*
