...
def track_snmp_traps(trap_server,trapcmd,filename):
    ...
    try:
        ...
        child.sendline("scp -o StrictHostKeyChecking=no -pr root@"+trap_server+":/root/"+filename+" /root")
    ...
    search_txt=[config.grid_vip,config.grid_member1_vip,"DNS Service is working","DHCP Service is working","DHCP Service is inactive","FTP Service is working","FTP Service is inactive","TFTP Service is working","TFTP Service is inactive","HTTP Service is working","HTTP Service is inactive","The system is rebooting","NTP Service is inactive","LDAP service is inactive","DoT/DoH is Inactive"]
...
class NIOS_87171(unittest.TestCase):
    ...
    def test_007_validate_Threat_analytics_service_working(self):
        print("\n============================================\n")
        ...
        response1=json.loads(get_ref)
        print(response1)
        ref_obj = response1[0]['enable_service']
        if ref_obj==True:
    ...
    def test_050_validate_snmpv1_2_3_trap_enabled_on_grid_level(self):
        ...
        trap_add1 = get_ref[1]['snmp_setting']['trap_receivers'][0]['address']
        v3trap_en = get_ref[1]['snmp_setting']['snmpv3_traps_enable']
        v3q_user = get_ref[1]['snmp_setting']['snmpv3_queries_users'][0]['user']['name']
        trap_add = get_ref[1]['snmp_setting']['trap_receivers'][1]['address']
        print(trap_add)
        if v3trap_en==True and 'snmptest' == v3q_user and trap_add==config.client_ip and trap_add1==config.trap_receiver_ip:
    ...
    def test_051_perform_snmp_command_at_member_level(self):
        ...
        validate_snmp_command_on_v1(stdout_v1,'Threat Analytics Service is working',"SNMPTABLE",client,"member")
        validate_snmp_command_on_v2(stdout_v2,'Threat Analytics Service is working',"SNMPTABLE",client,"member")
        validate_snmp_command_on_v3(stdout_v3,'Threat Analytics Service is working',"SNMPTABLE",client,"member")
    ...
    def test_056_check_SNMPV3_engineboot_values_on_HA_member(self):
        get_ref = ib_NIOS.wapi_request('GET', object_type="member?_return_fields=snmp_setting")
        get_ref=json.loads(get_ref)
        memref = get_ref[2]['_ref']
        print(memref)
        print("\n============================================\n")
    ...
    def test_059_Taking_Grid_Backup_File(self):
    ...
    def test_060_Restore_Grid_Backup_File(self):
    ...
    def test_061_validate_snmpv_configuration_after_grid_restore(self):
        print("\n============================================\n")
    ...
    def test_063_validate_all_enabled_services_inactive(self):
        print("\n============================================\n")
