...
"""
args=sys.argv[1:]
optlist, args = getopt.getopt(args,'m:v:s:d:')
...
for i,memberid in enumerate(D[1:]):
    var_hash["GRID_MEMBER"+str(i+1)+"_ID"]=memberid
...
#cmd = "py.test VADPGA-143/test_vadp_bug_automation.py --tb=long --html=vadpga_bugs_report.html --junit-xml=vadpga_bug_results.xml -vv"
#rm = os.system(cmd)

#sleep(120)
#cmd1 = "py.test VADPGA-143/test_sid.py --tb=long --html=vadpga_143_report.html --junit-xml=vadpga_143_results.xml -vv"
#rm = os.system(cmd1)
