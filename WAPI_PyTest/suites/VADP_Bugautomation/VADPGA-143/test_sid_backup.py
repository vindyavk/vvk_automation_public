...
class NetworkView(unittest.TestCase):
    ...
    def test_1_validate_blacklist_udp_fqdn_lookup_validate_sid_txt_file(self):
      ...
      # ref_version_2 = json.loads(get_ruleset)[1]['version']
        ...
        execute_dnsq='dnsq -ns='+str(config.grid_member1_vip)+' -qname=black_udp.com -qtype=A -repeat=9 -wait=0.03' 
    ...
    def test_2_delete_custom_rule_blacklist_udp_fqdn(self):
    ...
    def test_3_validate_blacklist_tcp_fqdn_lookup_validate_sid_txt_file(self):
    ...
    def test_4_delete_custom_rule_blacklist_tcp_fqdn(self):
    ...
    def test_5_validate_rate_limited_tcp_fqdn_with_blocking_option_validate_sid_txt_file(self):
      ...
      # ref_version_2 = json.loads(get_ruleset)[1]['version']
        ...
        execute_dnsq='for i in {1..10};do dnsq -ns='+str(config.grid_member1_vip)+' -qname=rate_tcp.com -protocol=tcp -wait=0.03;done' 
        logs_dnsq=os.system(execute_dnsq)
        sleep(90)
    ...
    def test_6_update_log_severity_and_fqdn_for_rate_limited_tcp_fqdn_lookup(self):
     ...
     #  ref_version_2 = json.loads(get_ruleset)[1]['version']
        ...
        get_custom_rule_2 = ib_NIOS.wapi_request('GET',object_type='threatprotection:grid:rule?name~=Rate%20Limited.*')
        factory = json.loads(get_custom_rule)
        ...
        execute_dnsq='for i in {1..10};do dnsq -ns='+str(config.grid_member1_vip)+' -qname=rate_tcp_modified.com -protocol=tcp -wait=0.03;done'
        logs_dnsq=os.system(execute_dnsq)
        sleep(90)
    ...
    def test_7_delete_custom_rule_rate_limited_tcp_fqdn(self):
    ...
    def test_8_validate_rate_limited_udp_fqdn_blocking_validate_sid_txt_file(self):
   ...
   #     sid_value = custom_rule['sid']
        ...
        execute_dnsq='for i in {1..10};do dnsq -ns='+str(config.grid_member1_vip)+' -qname=rate_udp.com -protocol=udp -wait=0.03;done' 
        logs_dnsq=os.system(execute_dnsq)
        sleep(90)
        ssh_cmd ='ssh -o StrictHostKeyChecking=no -o BatchMode=yes -o UserKnownHostsFile=/dev/null -q root@'+str(config.grid_member2_vip)+' " grep -A 4 '+str(sid_value)+' /infoblox/var/atp_sid_hits.txt | grep -v '+str(sid_value)+'  " '
        out = commands.getoutput(ssh_cmd)
    ...
    def test_9_update_log_severity_and_fqdn_for_rate_limited_udp_fqdn_lookup_rate_limiting(self):
        ...
        execute_dnsq='for i in {1..10};do dnsq -ns='+str(config.grid_member1_vip)+' -qname=rate_udp_modified.com -protocol=udp -wait=0.03;done'
        logs_dnsq=os.system(execute_dnsq)
        sleep(90)
    ...
    def test_10_delete_custom_rule_rate_limited_udp_fqdn_lookup(self):
    ...
    def test_11_validate_validate_rate_limited_tcp_ip_sid(self):
    ...
    def test_12_update_log_severity_and_fqdn_for_rate_limited_tcp_fqdn_lookup(self):
    ...
    def test_13_validate_auto_rule_sid_txt_file(self):
    ...
    def test_14_validate_system_rule_validate_sid_txt_file(self):
