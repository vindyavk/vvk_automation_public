...
class NetworkView(unittest.TestCase):
    ...
    def test_1_vadpga_212_bug_automation(self):
        ...
        get_rule_temp_ref = ib_NIOS.wapi_request('GET', object_type='threatprotection:grid:rule?sid='+config.sid_nu+'&ruleset='+str(ref_version_2))
        ...
        if type(modify_disable_field) == tuple:
            print("Failure: modify disable field")
            assert False
...
#        sleep(10)
        ...
        try:
            ...
            print("Failure:dnsq command failed")
            print(e)
        sleep(10)    
    ...
    def test_3_vadpga_297_automation(self):
        ...
        if type(response) == tuple:
            ...
            if response[0]==400 or response[0]==401:
                print("Failure: Validate by Removing MGMT Interface while TP Service Running")
                assert False
            else:
                print("Success: Validate by Removing MGMT Interface while TP Service Running")
                assert True
    ...
    def test_4_vadpga_226_automation(self):
        ...
        print(logs)
        if logs:
            print("Success: Validate Traffic capture started")
            assert True
        else:
            print("Failure:  Validate Traffic capture started")
            assert False
    ...
    def test_5_vadgpa_197(self):
	    ...
	    cmd='~/API_Automation_08_12_20/WAPI_PyTest/suites/VADP_Bugautomation/VADPGA-143/set_hardware_type_negative.exp ' +str(config.grid_member4_vip)
    ...
    def test_6_vadpga_284_automation(self):
        ...
        if type(response) == tuple:
	        ...
	        if response[0]==400 or response[0]==401:
                print("Failure: Set vpn_enabled equal to true")
		        assert False
	        else:
                print("Success: Set vpn_enabled equal to true")
		        assert True
        ...
        if type(response) == tuple:
            ...
            if response[0]==400 or response[0]==401:
                print("Failure: Set vpn_enabled equal to false")
                assert False
            else:
                print("Success: Set vpn_enabled equal to false")
                assert True
    ...
    def test_7_vadpga_305_automation(self):
        ...
        sleep(180)  
        try:
            cmd=commands.getstatusoutput('/home/vadga-143/IB/qa/vadpga-143/FR/show_hardware_type_detailed.exp ' +str(config.grid_member2_vip))
            print cmd[1]
        except Exception as e:
            print(e)
    ...
    def test_9_VADPGA_241(self):
        ...
        cmd=commands.getstatusoutput('~/API_Automation_08_12_20/WAPI_PyTest/suites/VADP_Bugautomation/VADPGA-143/show_capacity_type_3.exp ' +str(config.grid_member4_vip))
        print cmd[1]
