...
class NIOSSPT_9412(unittest.TestCase):
    ...
    def test_000_setup(self):
        ...
        display_msg("Allow recursive query")
        grid_dns_ref = ib_NIOS.wapi_request('GET', object_type='grid:dns',grid_vip=config.grid2_vip)
        data =  {"recursive_query_list": [{"address": "Any", "permission": "ALLOW"}]}
        ...
        '''Add DNS Resolver'''
        display_msg("Add DNS Resolvers 127.0.0.1, 10.103.3.10")
        grid_ref = ib_NIOS.wapi_request('GET', object_type='grid')
        data = {"dns_resolver_setting":{"resolvers":["127.0.0.1","10.103.3.10"]}}
        response = ib_NIOS.wapi_request('PUT', ref=json.loads(grid_ref)[0]['_ref'], fields=json.dumps(data))
        display_msg(response)
    ...
    def test_005_send_dig_query_1(self):
        """
            ...
            for i in zone:
                  for j in rec_count:
                        for record in query_list:
                              query_cmd1= os.system('dig @'+config.grid_vip+' '+"a_rec"+str(j)+"."+str(i)+" IN "+ str(record))
                              print (query_cmd1)
    ...
    def test_006_check_Cores_Storage_File(self):
        print("/n")
        print("############################################################################################")
    ...
    def test_007_check_for_show_smartnic_command(self):
        print("/n")
	print("############################################################################################")
    ...
    def test_008_add_subscriber_data(self):
    ...
    def test_009_validate_added_subscriber_data(self):
        print("\n")
        print("###############################################################################")
    ...
    def test_010_add_subscriber_data_member(self):
    ...
    def test_011_validate_added_subscriber_data(self):
        print("\n")
        print("###############################################################################")
	...
	#fwd_zone=["fwd1.com","fwd2.com","fwd3.com","fwd4.com","fwd5.com","fwd6.com","fwd7.com","fwd8.com","fwd9.com","fwd10.com"]
	    ...
	    zone1_ref=json.loads(zone)[0]['_ref']
            #forward_zone={"fqdn":str(i),"forward_to":[{"address":config.Master2_MGMT_IP,"name":config.grid2_fqdn}]}
