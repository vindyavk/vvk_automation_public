...
class SubscriberRPZ(unittest.TestCase):
	...
	print("Performing service restart operation")
        ...
        print("Restart service happened successfully")
	print("sleeping for 650 seconds")
	time.sleep(650)
        print("#####################################")

	cls.detailed_subscriber = [{"Total Subscriber Hits":"1","Malicious Domains":"playboy.com","RPZ Entries":"playboy.com","RPZ Severity":"MAJOR"}]
	cls.rpz_trend_mitigation = [{"Substitute":"1.0","ClientHits":"1.0"}]
	cls.rpz_top_hits = [{"Total Client Hits":"1","Domain Name":"playboy.com","RPZ Entry":"playboy.com","Total Rule Hits":"1"}]
	cls.rpz_top_hits_clients = [{"Total Client Hits":"1"}]
	cls.top_dns_firewall_hits = [{"RPZ_QNAME":"playboy.com","DOMAIN_NAME":"playboy.com","RPZ_HIT_COUNT":"1","ALL_HIT_COUNT":"1","RPZ_HIT_PCT":"100.00"}]
	cls.firewall_exec_threat = [{"RPZ Rule":"playboy.com","Percentage":"100.00","# Hits":"1"}]
	cls.malicious_client = [{"# Hits":"1"}]
        print("sleeping for 650 seconds")
        time.sleep(650)
