...
a = os.system("sed -i 's/grid_fqdn=\"ib-10-36/grid_fqdn=\"ib-10-35/g' config.py")
print("MODIFIED TO ib-35-....",a)
sleep(10)
#echo -e "cat_acctname=\"infoblox_sdk\"" >> config.py
#echo -e "cat_password=\"LinWmRRDX0q\"" >> config.py
#echo -e "category_url=\"https://dl.zvelo.com\"" >> config.py
#echo -e "pc_zone_name=\"pc.com\"" >> config.py
...
if(run_type == 'single_indexer' or  'single_site_cluster' or 'multi_site_cluster'):
    ...
    args_str = "-k test_MNG --tb=long --html=mg_report.html --junit-xml=mg_results.xml -vss"
    #args_str = "-k test_MNG -vss"
