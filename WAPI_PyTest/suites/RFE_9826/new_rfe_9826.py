...
class RFE_9826(unittest.TestCase):
        ...
        def test_039_validate_syslog_for_doh_key_logging(self):
                logging.info("Validating syslog logs for doh key logging")
                sleep(20)
                sys_log_validation = 'ssh -o StrictHostKeyChecking=no -o BatchMode=yes -o UserKnownHostsFile=/dev/null root@'+str(config.member1_mgmt)+' " tail -400 /var/log/syslog"'
                out1 = commands.getoutput(sys_log_validation)
                logging.info (out1)
                print(out1,"output of log")
        ...
        def test_040_start_Syslog_Messages(self):
            log("start","/var/log/syslog",config.grid_vip)
            logging.info("test case passed")
            sleep(10)

        @pytest.mark.run(order=41)
        def test_041_changing_resolver_from_bind_to_unbound(self):
        ...
        def test_042_stop_Syslog_Messages(self):
            log("stop","/var/log/syslog",config.grid_vip)
            logging.info("Test Case Execution Completed")
       ...
       # Debug log verification for the above test case:
        ...
        def test_043_validate_debug_log_for_resolver_changes(self):
                logging.info("Validating debug logs for resolver changes")
                sleep(60)
                sys_log_validation = 'ssh -o StrictHostKeyChecking=no -o BatchMode=yes -o UserKnownHostsFile=/dev/null root@'+str(config.member1_mgmt)+' " tail -200 /infoblox/var/infoblox.log"'
                out1 = commands.getoutput(sys_log_validation)
                logging.info (out1)
                print(out1)
        ...
        def test_044_validate_syslog_for_resolver_changes(self):
                logging.info("Validating syslog logs for resolver changes")
                sleep(120)
                sys_log_validation = 'ssh -o StrictHostKeyChecking=no -o BatchMode=yes -o UserKnownHostsFile=/dev/null root@'+str(config.member1_mgmt)+' " tail -200 /var/log/syslog"'
                out1 = commands.getoutput(sys_log_validation)
                logging.info (out1)
                print(out1)
       ...
       # This case to check the DoH Status is populated in the DoH enabled member1 having unbound resolver type
        ...
        def test_045_check_doh_status_in_standalone_member1_in_unbound_resolver(self):
        ...
        def test_046_check_dot_status_in_standalone_member1_having_unbound_resolver(self):
...
# The following test cases are to check on Member 2 which is IB-v1415
        ...
        def test_047_enable_ADP_on_standalone_member2_level(self):
        ...
        def test_048_validate_debug(self):
        ...
        def test_049_enable_DoH_and_dot_on_standalone_member2(self):
        ...
        def test_050_validate_debug_logs_for_enabling_doh_dot_feature(self):
                logging.info("Validating debug logs for enabling DoH/DoT feature")
                child = pexpect.spawn('ssh -o StrictHostKeyChecking=no admin@'+config.member2_mgmt)
                child.logfile=sys.stdout
                child.expect('password:')
        ...
        def test_051_check_memory_size_allocated_fastpath_with_DoH_and_DoT(self):
        ...
        def test_052_check_listen_on_port_details_for_DOH_in_Standalone_member2(self):
        ...
        def test_053_check_listen_on_port_details_for_dot_in_Standalone_member2(self):
        ...
        def test_054_check_dca_json_details_for_DOH_in_Standalone_member2(self):
                logging.info("Check dca json details for DOH in standalone member 1")
                child = pexpect.spawn('ssh -o StrictHostKeyChecking=no root@'+config.member2_mgmt)
                child.logfile=sys.stdout
                child.expect('.*bash.*')
        ...
        def test_055_check_dca_json_details_for_dot_in_Standalone_member2(self):
        ...
        def test_056_check_response_details_of_DoH_query_with_edns(self):
            logging.info("Check DoH response details by making a query with EDNS padding")
        ...
        def test_057_check_response_details_of_DoH_query_with_non_edns(self):
            logging.info("Check DoH response details by making a query with EDNS padding")
        ...
        def test_058_check_response_details_of_DoT_query_with_edns(self):
            logging.info("Check DoT response details by making a DoT query")
        ...
        def test_059_check_rx_tx_open_close_sessions_DoH_query(self):
            logging.info("Check rx, tx, open, close sessions for DoH queries")
            child = pexpect.spawn('ssh -o StrictHostKeyChecking=no admin@'+config.member2_mgmt)
            path = config.backup_path + "/mylog.txt"
            child.logfile=open(path,'wb')
        ...
        def test_060_check_rx_tx_open_close_sessions_DoT_query(self):
            logging.info("Check rx, tx, open, close sessions for DoT queries")
            child = pexpect.spawn('ssh -o StrictHostKeyChecking=no admin@'+config.member2_mgmt)
            path = config.backup_path + "/mylog.txt"
            child.logfile=open(path,'wb')
        ...
        def test_061_changing_hostname_member_doh_enable(self):
        ...
        def test_062_validate_debug(self):
                logging.info("Validating debug logs")
                sleep(120)
