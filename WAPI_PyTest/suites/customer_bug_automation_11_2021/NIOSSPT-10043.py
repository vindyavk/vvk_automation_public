...
#  1. Grid Master (HA) - 8.5.3 build   With LAN2 and MGMT configured        #
...
class NIOSSPT_10043(unittest.TestCase):
    ...
    # set interface_mtu for LAN1 using cli before enabling port redundency
    @pytest.mark.run(order=1)
    def test_001_set_interface_mtu_for_LAN1(self):
        print("\n========================================================\n")
        ...
        try:
            ...
            child.sendline("set interface_mtu lan 1450")
            child.expect("Infoblox >")
            print("SUCCESS: MTU Value has been successfully set for LAN1 interface")
            assert True

        except Exception as e:
            print(e)
            child.close()
            print("FAILURE: Something went wrong...MTU value was not set!")
            assert False
    ...
    # set interface_mtu for LAN2 using cli before enabling port redundency
    @pytest.mark.run(order=2)
    def test_002_set_interface_mtu_for_LAN2(self):
        print("\n========================================================\n")
        ...
        try:
            ...
            child.sendline("infoblox")
            child.expect("Infoblox >")
            child.sendline("set interface_mtu lan2 1450")
            child.expect("Infoblox >")
            print("SUCCESS: MTU Value has been successfully set for LAN2 interface")
            assert True
    ...
    # set interface_mtu for MGMT using cli before enabling port redundency
    @pytest.mark.run(order=3)
    def test_003_set_interface_mtu_for_MGMT(self):
        print("\n========================================================\n")
        print("Set interface mtu for MGMT using cli")
        print("\n========================================================\n")
        ...
        try:
            ...
            child.sendline("infoblox")
            child.expect("Infoblox >")
            child.sendline("set interface_mtu mgmt 1450")
            child.expect("Infoblox >")
            print("SUCCESS: MTU Value has been successfully set for MGMT interface")
            assert True
    ...
    # set interface_mtu for HA using cli before enabling port redundency
    @pytest.mark.run(order=4)
    def test_004_set_interface_mtu_for_HA(self):
        print("\n========================================================\n")
        print("Set interface mtu for HA using cli")
        print("\n========================================================\n")
        ...
        try:
            ...
            child.sendline("infoblox")
            child.expect("Infoblox >")
            child.sendline("set interface_mtu ha 1450")
            child.expect("Infoblox >")
            print("SUCCESS: MTU Value has been successfully set for HA interface")
            assert True
...
# Enable port redundancy on LAN1 and LAN2
    ...
    def test_005_Enable_port_redundancy_on_LAN1_LAN2(self):
        print("\n========================================================\n")
...
# Validating if the port redundancy is enabled
    ...
    def test_006_validate_port_redundancy(self):
        print("\n========================================================\n")
...
# set interface_mtu for LAN1 using cli after enabling port redundancy
    @pytest.mark.run(order=7)
    def test_007_set_interface_mtu_for_LAN1(self):
        print("\n========================================================\n")
        print("Set interface mtu for LAN1 using cli")
        print("\n========================================================\n")
...
# set interface_mtu for LAN2 using cli after enabling port redundancy
    @pytest.mark.run(order=8)
    def test_008_set_interface_mtu_for_LAN2(self):
        print("\n========================================================\n")
        print("Set interface mtu for LAN2 using cli")
        print("\n========================================================\n")
...
# set interface_mtu for MGMT using cli after enabling port redundancy
    @pytest.mark.run(order=9)
    def test_009_set_interface_mtu_for_MGMT(self):
        print("\n========================================================\n")
        print("Set interface mtu for MGMT using cli")
        print("\n========================================================\n")
        ...
        try:
            ...
            print("SUCCESS: MTU Value of MGMT has been successfully set with port redundancy enabled")
            assert True

        except Exception as e:
            print(e)
            child.close()
            print("FAILURE: Something went wrong...MTU value was NOT set when port redundancy is enabled!")
            assert False
...
# set interface_mtu for HA using cli after enabling port redundancy
    @pytest.mark.run(order=10)
    def test_011_set_interface_mtu_for_HA(self):
        print("\n========================================================\n")
        print("Set interface mtu for HA using cli")
        print("\n========================================================\n")
        ...
        try:
            ...
            print("SUCCESS: MTU Value of HA has ben successfully set with port redundancy enabled")
            assert True
