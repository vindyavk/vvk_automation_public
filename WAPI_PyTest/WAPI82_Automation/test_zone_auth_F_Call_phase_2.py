...
class zone_auth(unittest.TestCase):
	...
	def test_2_lock_unlock_zone_FC_zone_auth(self):
		get_ref = ib_NIOS.wapi_request('GET', object_type="zone_auth")
		logging.info(get_ref)
		res = json.loads(get_ref)
		ref = json.loads(get_ref)[0]['_ref']
		print ref
		logging.info("Test the lock_unlock_zone function call in zone_auth object")
		data ={"operation": "LOCK"}
	...
	def test_3_lock_unlock_zone_FC_zone_auth(self):
		get_ref = ib_NIOS.wapi_request('GET', object_type="zone_auth")
		logging.info(get_ref)
		res = json.loads(get_ref)
		ref = json.loads(get_ref)[0]['_ref']
	...
	def test_4_lock_unlock_zone_FC_zone_auth_datatype(self):
		get_ref = ib_NIOS.wapi_request('GET', object_type="zone_auth")
		logging.info(get_ref)
		res = json.loads(get_ref)
		ref = json.loads(get_ref)[0]['_ref']
		print ref
		logging.info("Test the lock_unlock_zone function call in zone_auth object with the datatype of operation field")
		data ={"operation": True}
	...
	def test_5_DELETE_lock_unlock_zone_FC_zone_auth(self):
		get_ref = ib_NIOS.wapi_request('GET', object_type="zone_auth")
		logging.info(get_ref)
		res = json.loads(get_ref)
		ref = json.loads(get_ref)[0]['_ref']
		print ref
		logging.info("Test DELETE on lock_unlock_zone function call in zone_auth object")
	...
	def test_6_Update_lock_unlock_zone_FC_zone_auth_datatype(self):
		get_ref = ib_NIOS.wapi_request('GET', object_type="zone_auth")
		logging.info(get_ref)
		res = json.loads(get_ref)
		ref = json.loads(get_ref)[0]['_ref']
		print ref
		logging.info("Test Update lock_unlock_zone function call in zone_auth object with the datatype of operation field")
		data ={"operation": "UNLOCK"}
	...
	@pytest.mark.run(order=7)
        def test_7_DELETE_Zone_Auth(self):
                get_ref = ib_NIOS.wapi_request('GET', object_type="zone_auth")
                logging.info(get_ref)
                res = json.loads(get_ref)
                ref = json.loads(get_ref)[0]['_ref']
